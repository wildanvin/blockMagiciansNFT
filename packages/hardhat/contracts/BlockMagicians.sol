...
contract BlockMagicians is ERC721, Ownable {
  ...
  function tokenURI(uint256 id) public view override returns (string memory) {
      ...
      string memory description = string(abi.encodePacked('This magician uses ',protocols[protocolInfo[id]],' block magic of color #',protocolColor[protocolInfo[id]].toColor(),' to fight Moloch!!'));
  ...
  function generateSVGofTokenById(uint256 id) internal view returns (string memory) {
    ...
    string memory svg = string(abi.encodePacked(
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 400" width="300" height="400" shape-rendering="geometricPrecision">',
        renderTokenById(id),
      '</svg>'
    ));
  ...
  function renderTokenById(uint256 id) public view returns (string memory) {
    string memory render = string(abi.encodePacked(
      ...
      '<g transform="translate(155 336)">',
        '<g>',
          '<rect width="6" height="13.12" rx="0" ry="0" transform="matrix(.86-.51558 0.59 0.98 0 0)" fill="#0A212E" stroke-width="0"/>',
          ...
          '<ellipse rx="15" ry="15" transform="matrix(.465 0 0 0.44 34.25 -24.6)" fill="#',
          protocolColor[protocolInfo[id]].toColor(),
          '" stroke-width="0"/>',
      ...
      '</g>',
      //leftArm:
      '<rect width="6" height="13.12" rx="0" ry="0" transform="matrix(.98044 .1968 -.225 1.12094 136.4 346)" fill="#0A212E"/>',
      '<rect width="6" height="13.12" rx="0" ry="0" transform="matrix(.98044 .1968 -.225 1.12094 139.059 333)" fill="#0A212E"/>',
      //head:
      '<rect width="6" height="20" rx="0" ry="0" transform="matrix(1.33333 0 0 .3 146 325)" fill="#0A212E"/>',
      //hat:
      '<path fill="#',
          protocolColor[protocolInfo[id]].toColor(),
          '" d="m150 302.5 4 7.5h-8zm-4 7.5h8l2 12h-12z"/>',
      '<ellipse rx="15" ry="3" transform="translate(150 322)" fill="#',
          protocolColor[protocolInfo[id]].toColor(),
          '"/>',
      //shoulders:
      '<path d="M146 329h8l7 4h-22z" fill="#',
          protocolColor[protocolInfo[id]].toColor(),
          '"/>',
      //shadowLines:
      '<rect width="30" height="15" rx="0" ry="0" transform="matrix(3.36444 0 0 .13012 0 382)" fill="#c4a57c"/>',
      '<rect width="30" height="15" rx="0" ry="0" transform="matrix(3.36444 0 0 .13012 200 382)" fill="#c4a57c"/>',
      '<rect width="30" height="15.371" rx="0" ry="0" transform="matrix(3.36444 0 0 .13012 99.533 374.722)" fill="#0a212e"/>',
      //cape:
      '<path d="M139 333h22l4 53h-30z" fill="#',
          protocolColor[protocolInfo[id]].toColor(),
          '"/>',
      '<rect width="30" height="15.371" rx="0" ry="0" transform="matrix(1.7344 0 0 .13012 131.984 388)" fill="#0a212e"/>',
      //cloudLines:
      ...
      '<g fill="#0a212e" style="transform-origin: center;">',
        ...
        '<animate attributeName="fill" values="#0a212e;#0a212e;#',
          protocolColor[protocolInfo[id]].toColor(),
          ';#0a212e;#0a212e" keyTimes="0; 0.8; 0.85; 0.95; 1" dur="5s" repeatCount="indefinite"/>',
      '</g>',
      //clouds:
      '<g fill="#fdffe8">',
        '<ellipse rx="45.118" ry="47.697" transform="translate(52.159 238.525)"/>',
        '<ellipse rx="45.118" ry="65" transform="matrix(.67994 0 0 .4824 100 247)"/>',
        '<ellipse rx="45.118" ry="47.697" transform="matrix(.67994 0 0 .66913 155.08 258.757)"/>',
        '<ellipse rx="45.118" ry="47.697" transform="matrix(.56043 0 0 .66913 193.567 231.29)"/>',
        '<ellipse rx="45.118" ry="47.697" transform="matrix(.67994 0 0 .66913 230.922 206.61)"/>',
      '</g>',
      //stars:
      '<g fill="#0a212e" stroke="#0a212e" stroke-width=".8">',
        ...
        '<path d="M29.958 39.957c-.037 5.066 4.97 10.112 10.118 10.119-5.19-.065-10.148 4.914-9.976 9.904-.406-4.399-4.772-10.203-10.19-10.047 5.11.046 10.269-4.759 10.048-9.976Z" transform="matrix(.51097 0 0 .53193 34.73 6.527)"/>',
        '<path d="M29.958 39.957c-.037 5.066 4.97 10.112 10.118 10.119-5.19-.065-10.148 4.914-9.976 9.904-.406-4.399-4.772-10.203-10.19-10.047 5.11.046 10.269-4.759 10.048-9.976Z" transform="matrix(.51097 0 0 .53193 253.819 85.989)"/>',
      '</g>',
      //towerLeft:
      '<g transform="translate(0 120)" fill="#0a212e">',
        ...
        '<rect width="50" height="86.722" rx="0" ry="0" transform="matrix(1 0 0 .76938 0 190)"/>',
        '<rect width="10" height="1.25" rx="0" ry="0" transform="matrix(1 0 0 4.00001 0 185)"/>',
        '<rect width="10" height="1.25" rx="0" ry="0" transform="matrix(1 0 0 4.00001 20.224 185)"/>',
        '<rect width="10" height="1.237" rx="0" ry="0" transform="matrix(1 0 0 4.04084 30.224 123.722)"/>',
        '<rect width="10" height="1.25" rx="0" ry="0" transform="matrix(1 0 0 4.00001 50 123.722)"/>',
        '<rect width="10" height="1.25" rx="0" ry="0" transform="matrix(1 0 0 4.00001 69.51 123.722)"/>',
        '<rect width="10" height="1.25" rx="0" ry="0" transform="matrix(1 0 0 4.00001 90.15 123.722)"/>',
      '</g>',
      //towerRight:
      ...
      '<g style="transform-origin: center;">',
        ...
        //molochClosingEyes:
        '<g>',
          '<path d="M145.102125,78.991243l-6.30581-4.015379-.024911,1.220558l4.159864,2.466027-3.707767.539211.639643.867981l1.644796-.289322l1.370664-.263025l1.309745-.210416.913776-.315635Z" transform="matrix(1 0 0 1.158033 0.000001-12.311199)" fill="#c5a47c" stroke-width="0.8"/>',
          '<path d="M145.102125,78.991243l-6.30581-4.015379-.024911,1.220558l4.159864,2.466027-3.707767.539211.639643.867981l1.644796-.289322l1.370664-.263025l1.309745-.210416.913776-.315635Z" transform="matrix(-1 0 0 1.158033 299.933973-11.951199)" fill="#c5a47c" stroke-width="0.8"/>',
        '</g>',
        //molochMouth:
        '<g fill="#fcffe5">',
          '<rect width="20" height="1.266" rx="0" ry="0" transform="translate(139.96 91.668)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.88059 -.87408 .71584 .72118 139.571 92.345)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.00876 -2.91386 .38057 .00114 140.867 95.506)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.01058 -3.51973 .47343 .00142 144.15 95.983)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.01058 -3.51973 .47343 .00142 154.725 95.983)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.01058 -3.51973 .47343 .00142 147.595 95.983)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.01058 -3.51973 .47343 .00142 151.094 95.983)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.00876 -2.91386 .38057 .00114 158.07 95.559)"/>'
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.88059 -.87408 .71584 .72118 142.851 92.325)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.88059 -.87408 .71584 .72118 146.511 92.405)"/>'
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.88059 -.87408 .71584 .72118 149.891 92.405)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.88059 -.87408 .71584 .72118 153.391 92.465)"/>',
          '<rect width="2.013" height="2.358" rx="0" ry="0" transform="matrix(.88059 -.87408 .71584 .72118 156.751 92.485)"/>',
        '</g>',
